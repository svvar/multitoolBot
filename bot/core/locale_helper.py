...
languages = {
    'uk': {
        'uk': '🇺🇦 Українcька', 'en': '🇬🇧 Англійська', 'ru': '🇷🇺 Російська', 'de': '🇩🇪 Німецька',
        'pl': '🇵🇱 Польська', 'es': '🇪🇸 Іспанська', 'fr': '🇫🇷 Французька', 'it': '🇮🇹 Італійська', 'pt': '🇵🇹 Португальська',
    },

    'ru': {
        'uk': '🇺🇦 Украинский', 'en': '🇬🇧 Английский', 'ru': '🇷🇺 Русский', 'de': '🇩🇪 Немецкий',
        'pl': '🇵🇱 Польский', 'es': '🇪🇸 Испанский', 'fr': '🇫🇷 Французский', 'it': '🇮🇹 Итальянский', 'pt': '🇵🇹 Португальский',
    },

    'en': {
        'uk': '🇺🇦 Ukrainian', 'en': '🇬🇧 English', 'ru': '🇷🇺 Russian', 'de': '🇩🇪 German',
        'pl': '🇵🇱 Polish', 'es': '🇪🇸 Spanish', 'fr': '🇫🇷 French', 'it': '🇮🇹 Italian', 'pt': '🇵🇹 Portuguese',
    }
}
